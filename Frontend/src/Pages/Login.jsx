    ...
    const handleSubmit = async (values, { setSubmitting, resetForm }) => {
        ...
        try {
            ...
            if (response.status === 201) {
                // for store token in localStorage 
            ...
            <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        {/* <button className="w-ful bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" onClick={() => loginWithRedirect()}>Log In With Social media </button> */}
                            ...
                            {({ isSubmitting }) => (
                                <Form className="space-y-4 md:space-y-2">
                                    <div>
                                        ...
                                        <Field type="text" name="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Jhon Doe" required />
                                    ...
                                    <button type="submit" className="w-ful bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" disabled={isSubmitting}>Sign in</button>
